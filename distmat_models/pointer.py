...
from distmat_models.base import Attention
...
class PtrNet(nn.Module):
    ...
    def forward(
        ...
        Args:
            ...
            bias: (batch_size, n_agents, n_nodes) ... distance info
        """
        ...
        if self.glimpse:
            context_w = self.context_attention(
                att_query, att_key, return_prob=True, bias=bias
        ...
        output_logit = self.output_attention(context, att_key, return_prob=False, bias=bias)
        # (batch_size, n_agents * n_nodes)
